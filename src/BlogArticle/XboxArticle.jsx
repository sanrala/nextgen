...
import dataGame from "../games.json";
                                  ...
                                  <>
                                    {ab.support === "Xbox Series" && (
                                      <Link
                                        key={item.id}
                                        to={{
                                          pathname: `/xboxArticle/${item.id}/${item.title}`,
                                          state: { itemData: item },
                                        }}
                                      >
                                        <MenuItem
                                    ...
                                    {ab.support === "Playstation 5" && (
                                      <Link
                                        key={item.id}
                                        to={{
                                          pathname: `/PlaystationArticle/${item.id}/${item.title}`,
                                          state: { itemData: item },
                                        }}
                                      >
                                        <MenuItem
                                    ...
                                    {ab.support === "Steam" && (
                                      <Link
                                        key={item.id}
                                        to={{
                                          pathname: `/jeuxvideo/${item.id}/${item.title}`,
                                          state: { itemData: item },
                                        }}
                                      >
                                        <MenuItem

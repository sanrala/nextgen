...
const FEATURED_STREAMERS = ["ninja", "squeezie", "gotaga","anyme023", "animematue", "locklear", "kamet0","inoxtag" ,"michou", "tonton", "oonolive", "jbast62", "upblablah"]; // même liste que TwitchSection — à terme: Firebase

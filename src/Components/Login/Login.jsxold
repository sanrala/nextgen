  ...
  return (
    <div className="login-container">
      <div className="login-form">
        ...
        <h2>Se connecter</h2>
        <div className="links">
          <a onClick={handleGoogleSignIn} className="google signin-btn-google">
            <svg
          ...
          <a
            ...
            data-redirect="https://www.instant-gaming.com/fr/sign-in/discord/?redirect=https%3A%2F%2Fwww.instant-gaming.com%2Ffr%2F"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
